...
export const customInstance = <T>(config: AxiosRequestConfig): Promise<AxiosResponse<T>> => {
  ...
  const token = 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ1aWQiOjE0LCJ1c2VybmFtZSI6IuWcn-aLqOm8oDIxMTUiLCJyb2xlIjoiUk9MRV9BRE1JTiIsImV4cCI6MTc0NTI0MjMyNjI3MX0.TWtIjcfNRcIfEaFppVC71tkCHYgCMreLsoGK2XnNgeE';
