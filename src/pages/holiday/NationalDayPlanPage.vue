...
const scheduleData = ref<ScheduleItem[]>([
  ...
  // 10.4 下午 - 超然楼
  {
    ...
    location: '超然楼',
    type: '景点',
    description: '超然楼与大明湖一样，也位于济南，坐落在大明湖畔。其名取自宋代苏轼名篇《超然台记》，寓意超然物外。标志形象是号称"江北第一楼"的雄伟宋式楼阁。它原是元代古迹，如今是2008年重建的文化地标，供游客登楼观光，感受泉城魅力',
    highlights: ['免费登楼', '夜景观赏'],
    route: '不用买票上楼，每晚18:40亮灯，看亮灯即可',
    notes: '📍机位1：搜索"南丰祠新区游船码头"，可拍到南丰桥与超然楼同框\n📍机位2：搜索"尚泉尚水茶馆"，其前面平台即可拍摄湖面与楼阁全景',
    completed: false
  },
  // 10.5 上午 - 你好酒店→趵突泉
  {
  ...
  // 10.6 下午 - 八大局
  {
    ...
    location: '八大局',
    type: '美食',
    description: '"八大局"便民市场实际位于淄博市。它因曾地处当地财政、民政等八个政府机关（局）附近而得名。其标志是人潮汹涌的美食街景。它的故事是从一个本地人的普通菜市场，借助网络热度，爆火成为全国闻名的美食朝圣地',
    highlights: ['白老三炒锅饼', '博山菜', '淄博烧烤'],
    route: '一条南北向的主街+两条东西向的次街（东一街+东二街）。【主街】以紫米饼、炒锅饼、文创等面向游客的产品为主。【次街】东一街有本地居民常去的菜市场和早餐店，东二街是比较商业化，做游客生意',
    notes: '美食推荐：\n🌟白老三炒锅饼、麦香面食紫米饼\n🍱 博山菜：炸肉和风味茄子\n🍢 烧烤：走之前再去趟烧烤店',
    completed: false
  },
  // 10.6 晚上 - 淄博→青岛
